        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <form action="{{ route('employees.index', ['page' => $page]) }}" id="register-form" method="POST"
                        ...
                        <div class="d-flex align-items-baseline mb-4 my-2">
                            ...
                            <div class="col-md-8 ms-auto">
                                <input type="file"
                                    ...
                                    name="photo" value="{{ old('photo') }}" accept="image/*">
                                @error('photo')
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="col-md-8 offset-md-2 ms-auto">
                                <input type="text"
                                    ...
                                    name="employee_id" value="{{ $employee_id }}" disabled>
                                @error('id')
                        ...
                        <div class="d-flex align-items-center mb-5">
                            <span><label>{{ __('messages.CreateLanguage') }}</label><span class="required">*</span></span>
                            <div class="col-md-8 offset-md-2 ms-auto">
                        ...
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="col-md-8 offset-md-2 ms-auto">
                                <div>
                                    ...
                                    <div class="form-check form-check-inline" style="margin-left: 27px">
                                        <input
                                            class="form-check-input @if ($errors->has('prog_lang')) is-invalid @endif"
